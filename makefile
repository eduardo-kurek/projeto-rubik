...
test:
	$(CC) test.cpp rubik/*.cpp rubik/auxiliares/*.cpp rubik/scores/*.cpp -o $(OUT)

testO1:
	$(CC) test.cpp rubik/*.cpp rubik/auxiliares/*.cpp rubik/scores/*.cpp  -o $(OUT) -O1

testO2:
	$(CC) test.cpp rubik/*.cpp rubik/auxiliares/*.cpp rubik/scores/*.cpp  -o $(OUT) -O2
